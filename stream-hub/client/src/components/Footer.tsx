...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0a0b0f] border-t border-white/5 py-12 px-6 md:pl-32 mt-auto">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-gray-500">
        ...
        <div className="flex flex-wrap justify-center gap-6 font-medium items-center">
          ...
          <a 
            ...
            className="flex items-center gap-2 text-blue-400 hover:text-blue-300 transition-colors border border-blue-500/30 px-3 py-1.5 rounded-full hover:bg-blue-500/10"
          >
